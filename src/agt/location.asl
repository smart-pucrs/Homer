...
//Se o primeiro valor for menor que o segundo, o primeiro objeto está �  esquerda do segundo
leftOrRight(objectRepresentation(_,_,X,_,_),objectRepresentation(_,_,X2,_,_),Loc):- X<X2 & Loc="esquerda".
//Se o primeiro valor for maior que o segundo, o primeiro objeto está �  direita do segundo
...
//Se os objetos n�o tem o mesmo nome, passa para o pr�ximo
...
<-
	...
	.
+!getNumber([objectRepresentation(Name,C,X,Y,L)|RestOfTheList], List, NewList, Resp) // Se j� tem aquele nome na lista, passa para o pr�ximo
...
<-
	Resp=Temp;
	.
+!changeNames([objectRepresentation(Name,C,X,Y,L)|RestOfTheList], List, Temp, Resp)//Coloca um n�mero na frente do objeto e decrementa o n�mero salvo na lista para que o pr�ximo objeto com o mesmo nome fique com um n�mero diferente
