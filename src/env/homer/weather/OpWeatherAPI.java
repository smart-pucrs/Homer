...
public class OpWeatherAPI {
	...
	public String bomDia() { // Função para ser usada quando o usuário acordar (informa��es sobre o dia em quest�o)
		makeRequest();
	...
	// Classe auxiliar para lidar com datas e a conversão de tempo Epoch
