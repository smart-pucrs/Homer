...
public class DetectObjects {
	...
	public static Path inputPath = Paths.get("C:/Users/Davi/Pictures/Testes/TesteGato.JPG");
	public static Path outputPath = Paths.get("C:/Users/Davi/Pictures/Testes/OutputTpG.jpg");
	
	public static void main(String... args) throws Exception {
		detectLocalizedObjects(inputPath.toString(), System.out);
	}
	        ...
	        for (AnnotateImageResponse res : responses) {
	         ...
	         out.format("      #Results#    %n");
	          ...
	          for (LocalizedObjectAnnotation entity : res.getLocalizedObjectAnnotationsList()) {
	            ...
	            Object obj = new Object(name, entity.getScore(), objBoundCords); //Cria o objeto com seus respectivos valores
	            ...
	            out.format("Name: %s%nConfidence: %s%nCordinates: %s%nLocalização: %s%n%n", obj.getName(), 
	          	...
	          	if (!outputPath.toString().toLowerCase().endsWith(".jpg")) { //Confere se a imagem está no formato jpg
	          		System.err.println("outputImagePath must have the file extension 'jpg' !");
	          		System.exit(1);
	          	}
	          	out.format("Drawing result in output.jpg...%n"); 
	          	setDrawImages(inputPath, outputPath, res.getLocalizedObjectAnnotationsList());
	          	out.format("Done !%n%n"); 
	...
	public static void drawImages(BufferedImage img, List<LocalizedObjectAnnotation> objs) {
	     for (LocalizedObjectAnnotation entity : objs) {
	    	 double[][] objBoundCords  = wrapCords(entity.getBoundingPoly().getNormalizedVerticesList().toString());
	         Object obj = new Object(entity.getName(), entity.getScore(), objBoundCords);
	...
	public static void drawImage(BufferedImage img, LocalizedObjectAnnotation entity, Object obj) {
	...
	public static void drawCenter(Graphics2D gfx, Object obj, int scaleX, int scaleY) {
