...
public class CloudVision2 {
	public static List<ObjectRepresentation> detectLocalizedObjects(String diretorio)
		...
		System.out.format("|======Teste======|%n");
          ...
          ByteString imgBytes = ByteString.readFrom(new FileInputStream(diretorio));
	        ...
	        for (AnnotateImageResponse res : responses) {
	          ...
	          for (LocalizedObjectAnnotation entity : res.getLocalizedObjectAnnotationsList()) {
	            ...
	            Translation translation = translate.translate( entity.getName(), // Especificacoes da traducao
			       ...
			       System.out.printf("-> %s  | %s%n",name, obj.getDegrees());
